...
// 2007).
//===================================================================================
// v1.1: Changed Gaussianblur of logamplitude to averaging blur and gaussian
// kernel of saliency map to sigma = 8, kernelsize = 5
...
void SaliencyHou::calculateSaliencyMap(const Mat *src, Mat *dst) {
  ...
  blur(logAmplitude, logAmplitude_blur, Size(3, 3), Point(-1, -1),
       BORDER_DEFAULT);
